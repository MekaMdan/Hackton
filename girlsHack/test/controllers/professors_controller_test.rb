...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { create: @professor.create, delete: @professor.delete, index: @professor.index, show: @professor.show, update: @professor.update } }, as: :json
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { create: @professor.create, delete: @professor.delete, index: @professor.index, show: @professor.show, update: @professor.update } }, as: :json
    assert_response 200
  end
